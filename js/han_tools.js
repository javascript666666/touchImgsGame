...
// 默认时间：500
// 运动时间：easeOut
han.animate = function (obj, attrs, duration, fx, fn){
...
// 抖函数
han.shake = function (obj, attr, nums, fn){
  if(obj.shake) return;
  var arr = [], _this = this;
...
han.setTransform = function (obj, attr, val){
...
han.Tween = {
	...
	bounceIn: function(t, b, c, d){    //弹球减振（弹球渐出）
		return c - han.Tween['bounceOut'](d-t, 0, c, d) + b;
	},
	...
	bounceBoth: function(t, b, c, d){
		if (t < d/2) {
			return han.Tween['bounceIn'](t*2, 0, c, d) * 0.5 + b;
		}
		return han.Tween['bounceOut'](t*2-d, 0, c, d) * 0.5 + c*0.5 + b;
	}
}